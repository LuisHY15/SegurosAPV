...
if ( isset($_POST['nombre']) ){
	...
	$no_poliza      = mysql_real_escape_string($_POST['no_poliza']);
	$no_endozo      = mysql_real_escape_string($_POST['no_endozo']);
	...
	$prim_total     = mysql_real_escape_string($_POST['prim_total']);
